...
// GetTerraformResourceType returns Terraform resource type for this ProviderRegistration
func (mg *ProviderRegistration) GetTerraformResourceType() string {
	return "azurerm_resource_provider_registration"
}

// GetConnectionDetailsMapping for this ProviderRegistration
func (tr *ProviderRegistration) GetConnectionDetailsMapping() map[string]string {
	return nil
}

// GetObservation of this ProviderRegistration
func (tr *ProviderRegistration) GetObservation() (map[string]any, error) {
	o, err := json.TFParser.Marshal(tr.Status.AtProvider)
	if err != nil {
		return nil, err
	}
...
// SetObservation for this ProviderRegistration
func (tr *ProviderRegistration) SetObservation(obs map[string]any) error {
	p, err := json.TFParser.Marshal(obs)
	if err != nil {
		return err
	}
...
// GetID returns ID of underlying Terraform resource of this ProviderRegistration
func (tr *ProviderRegistration) GetID() string {
	if tr.Status.AtProvider.ID == nil {
		return ""
	}
	return *tr.Status.AtProvider.ID
...
// GetParameters of this ProviderRegistration
func (tr *ProviderRegistration) GetParameters() (map[string]any, error) {
	p, err := json.TFParser.Marshal(tr.Spec.ForProvider)
	if err != nil {
		return nil, err
	}
...
// SetParameters for this ProviderRegistration
func (tr *ProviderRegistration) SetParameters(params map[string]any) error {
	p, err := json.TFParser.Marshal(params)
	if err != nil {
		return err
	}
...
// GetInitParameters of this ProviderRegistration
func (tr *ProviderRegistration) GetInitParameters() (map[string]any, error) {
	p, err := json.TFParser.Marshal(tr.Spec.InitProvider)
	if err != nil {
		return nil, err
	}
...
// GetInitParameters of this ProviderRegistration
func (tr *ProviderRegistration) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
	params, err := tr.GetParameters()
	if err != nil {
		return nil, errors.Wrapf(err, "cannot get parameters for resource '%q'", tr.GetName())
	}
...
// LateInitialize this ProviderRegistration using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ProviderRegistration) LateInitialize(attrs []byte) (bool, error) {
...
// GetTerraformSchemaVersion returns the associated Terraform schema version
func (tr *ProviderRegistration) GetTerraformSchemaVersion() int {
	return 0
}
...
func (tr *Subscription) LateInitialize(attrs []byte) (bool, error) {
	...
	opts := []resource.GenericLateInitializerOption{resource.WithZeroValueJSONOmitEmptyFilter(resource.CNameWildcard)}
	opts = append(opts, resource.WithNameFilter("BillingScopeID"))
	opts = append(opts, resource.WithNameFilter("SubscriptionID"))
